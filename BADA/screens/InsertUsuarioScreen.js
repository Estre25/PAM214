...
export default function InsertUsuarioScreen() {
    ...
    // Renderizan cada usuario con manejo seguro de fecha
    const renderUsuario = ({ item, index }) => {
        // Manejo seguro de la fecha - prueba diferentes nombres de propiedad
        const fecha = item.fechaCreacion || item.fecha_creacion || item.fechaCreacion || new Date();
