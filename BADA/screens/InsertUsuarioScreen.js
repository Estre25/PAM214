...
export default function InsertUsuarioScreen() {
  ...
  const handleConfirmarEdicion = async () => {
    ...
    try {
      setGuardando(true);
      const usuarioActualizado = await controller.actualizarUsuario(usuarioEditando.id, nombre);
        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert('Usuario Eliminado', `"${usuario.nombre}" ha sido eliminado`);
            } catch (error) {
              Alert.alert('Error', error.message);
            }
          }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.insertSection}>
        ...
        <TouchableOpacity 
          style={[styles.button, (guardando || !nombre.trim()) && styles.buttonDisabled]} 
          onPress={editando ? handleConfirmarEdicion : handleAgregar}
